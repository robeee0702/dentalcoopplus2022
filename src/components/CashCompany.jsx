...
const CashCompany = (cartData) => {

  const [datas, setDatas] = useState([]);

  const deliverInfo = "Személyes átvétellel történt és céges rendelés"
  ...
  const handleSubmit = async (e) => {
    if (
      ...
      e.preventDefault();
      console.log({ email, phonenumber, fullName, city, address, postalCode, datak, deliverInfo });
